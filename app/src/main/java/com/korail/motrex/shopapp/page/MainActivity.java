...
import com.korail.motrex.shopapp.common.WebViewCustom;
import com.korail.motrex.shopapp.db.blacklist_DB;
import com.korail.motrex.shopapp.R;
import com.korail.motrex.shopapp.dialog.NotiDialog;
import com.korail.motrex.shopapp.dialog.OKDialog;
import com.korail.motrex.shopapp.listener.IPopUpButtonEventListener;
import com.korail.motrex.shopapp.listener.ITouchEventListener;
...
//        mWebView.loadUrl("about : blank");
        mWebView.loadUrl("https://www.cyso.co.kr/");
...
//                guide.setVisibility(View.INVISIBLE);
            ...
            case R.id.btn_02:{
                ...
                if("ko".equals(local_str)){
                    mWebView.loadUrl("http://alji.co.kr/");
                }else{
...
//                btn_layout.setVisibility(View.INVISIBLE);
            ...
            case R.id.btn_01:{
                ...
                if("ko".equals(local_str)){
                    mWebView.loadUrl("https://www.gwmart.kr/main/index");
                }else{
...
//                btn_layout.setVisibility(View.INVISIBLE);
            ...
            case R.id.btn_04:{
                if("ko".equals(local_str)){
                    mWebSettings.setUseWideViewPort(true);
                    mWebView.loadUrl("https://www.jbplaza.com/main/index");
                }else{
